...
export const metadata: Metadata = { title: 'Termini di Servizio · PB TAX International' }

const sections = [
  { title: '1. Definizione del servizio', body: 'PB TAX International Tax Consultants FZCO offre servizi di gestione contabile, fiscale e compliance per società negli Emirati Arabi Uniti. Il servizio costituisce consulenza contabile e fiscale — non consulenza legale ai sensi dell\'ordinamento italiano o UAE.' },
  ...
  { title: '7. Contatti', body: 'Per qualsiasi questione relativa ai presenti termini: info@pbtax.ae · WhatsApp: +971 58 597 1575' },
]
